...
class DialogAssinaturaTermoTratamentoDados extends StatefulWidget {
  ...
  const DialogAssinaturaTermoTratamentoDados({required this.pacienteUuid, required this.pacienteNome, Key? key}) : super(key: key);

  @override
  _DialogAssinaturaTermoTratamentoDadosState createState() => _DialogAssinaturaTermoTratamentoDadosState();
}

class _DialogAssinaturaTermoTratamentoDadosState extends State<DialogAssinaturaTermoTratamentoDados> {
  bool signed = false;
                ...
                Visibility(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(widget.pacienteNome),
                        ElevatedButton.icon(onPressed: () {

                          Navigator.pop(context, pacienteSignatureDialog);

                        }, icon: Icon(Icons.check_rounded), label: Text('Aceitar termo')),
                      ],
                    )),
                ElevatedButton.icon(
                  onPressed: () async {
