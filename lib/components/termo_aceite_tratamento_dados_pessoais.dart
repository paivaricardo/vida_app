  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: const <Widget>[
        ...
        Text('- Problemas de saúde específicos: ansiedade, depressão, dor e tabagismo'),
        Text('- Dados sobre a intensidade, frequência e início do tabagismo'),
        ...
        Text('- Resultados e pontuações alcançadas em questionários sobre ansiedade, depressão, dores e tabagismo, assim como apontamentos julgados necessários no momento da aplicação desses questionários.'),
        Padding(
          padding: EdgeInsets.only(top: 12.0),
        ...
        Text('- Possibilitar que o Controlador identifique o titular e levante dados para a condução de pesuisas sobre a aplicação de Práticas Integrativas e Complementares em Saúde (PICS) e seus efeitos sobre a saúde, em especial sobre ansiedade, depressão e tabagismo, condições cujos níveis serão mensurados por meio de aplicação de questionários sobre o Titular, durante atendimentos a serem realizados na unidade básica de saúde da Universidade Federal do Amapá (UNIFAP) ou no Laboratório de Análises Clínicas II (LAC-II) do Curso de Farmácia da UNIFAP.'),
        ...
        Text('O Controlador responsabiliza-se pela manutenção de medidas de segurança, técnicas e administrativas aptas a proteger os dados pessoais de acessos não autorizados e de situações acidentais ou ilícitas de destruição, perda, alteração, comunicação ou qualquer forma de tratamento inadequado ou ilícito.'),
